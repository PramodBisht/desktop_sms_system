...
namespace Pramod_sms_app {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonRow AddPersonRow(string pNumber, string pName) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonRow FindBypNumber(string pNumber) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public string pNumber {
                get {
                    return ((string)(this[this.tablePerson.pNumberColumn]));
                }
                set {
                    this[this.tablePerson.pNumberColumn] = value;
                }
            }
...
namespace Pramod_sms_app.Database1DataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Person` WHERE ((`pNumber` = ?) AND ((? = 1 AND `pName` IS NULL) OR (" +
                "`pName` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Person` (`pNumber`, `pName`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Person` SET `pNumber` = ?, `pName` = ? WHERE ((`pNumber` = ?) AND ((? = 1" +
                " AND `pName` IS NULL) OR (`pName` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Pramod_sms_app.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT pNumber, pName FROM Person";
        ...
        public virtual int Delete(string Original_pNumber, string Original_pName) {
        ...
        public virtual int Insert(string pNumber, string pName) {
            if ((pNumber == null)) {
        ...
        public virtual int Update(string pNumber, string pName, string Original_pNumber, string Original_pName) {
            if ((pNumber == null)) {
            ...
            if ((Original_pNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_pNumber));
            }
            if ((Original_pName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string pName, string Original_pNumber, string Original_pName) {
            return this.Update(Original_pNumber, pName, Original_pNumber, Original_pName);
        }
    }
